...
import {CreateUpstreamRequest, UpdateUpstreamRequest, Upstream} from "../types";
...
const Upstreams: React.FC = () => {
    ...
    const updateMutation = useMutation({
        mutationFn: ({id, data}: { id: string; data: UpdateUpstreamRequest }) =>
    ...
    const deleteMutation = useMutation({
        mutationFn: (id: string) => api.delete(`/upstreams/${id}`),
        onSuccess: () => {
